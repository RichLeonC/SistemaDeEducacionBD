...
export default function TopAusencias(){
    ...
    return (
        ...
        <br/>
         <h2 className="offset-md-6 font-weight-bold"> Top 10 de estudiantes con más ausencias</h2>
         <br/>
        <h2 className=" offset-md-7 font-weight-bold">{numSeleccionado} Semestre, {annoSeleccionado}</h2>
        <Button className="btn btn-primary mt-4 offset-md-2 " onClick={()=>abrirCerrarModalFiltro()} >Periodos</Button>
